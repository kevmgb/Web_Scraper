...
lblInfo = Label(Tops, font=('arial', 20, 'bold'), text=localtime, fg="Steel Blue",
                bd=10, anchor='w')
...
def Ref():
    ...
    CostofMeal = "$", str('%.2f' % (CostofFries + CostofDrinks + CostofFillet + CostofBurger
                                    + CostofChicken_Burger + CostofCheese_Burger))

    PayTax = ((CostofFries + CostofDrinks + CostofFillet + CostofBurger
                                    + CostofChicken_Burger + CostofCheese_Burger) * 0.2)

    TotalCost = (CostofFries + CostofDrinks + CostofFillet + CostofBurger
                                    + CostofChicken_Burger + CostofCheese_Burger)

    Ser_Charge = ((CostofFries + CostofDrinks + CostofFillet + CostofBurger
